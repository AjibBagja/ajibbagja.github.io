...
@section('breadcrumb')
	...
	<li class="active">
		<a href="{{url('seller/items/add')}}">Edit Item</a>
	</li>
@endsection
@section('breadcrumb_title','Edit Item - '.$data->nama_item)
            ...
            <div class="container">
                        ...
                        <div class="dashboard_title_area">
                            <div class="pull-left">
                                <div class="dashboard__title">
                                    <h3>Edit Item - {{$data->nama_item}}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-7">
						<form class="form" action="{{url('seller/items/update/'.$data->id_item)}}" method="post">
						    {{csrf_field()}}
                            <div class="upload_modules">
                                ...
                                <div class="modules__content">
                                    <div class="form-group">
                                        ...
                                        <div class="select-wrap select-wrap2">
                                            <select name="tipe_item" id="category" class="text_field">
											    <?php
											    	$dat = config("config.item_type");
											    ?>
											    @foreach($dat as $key => $d)
											    	<option value="{{$key}}"
											    		@if($key == $data->tipe_item)
											    			selected
											    		@endif
											    	>{{$d}}</option>
											    @endforeach
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="product_name" name="nama_item" required min="4" class="text_field" placeholder="Nama Item..." value="{{$data->nama_item}}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="item_price" name="harga_item" required min="1" class="text_field" placeholder="Harga Item..." value="{{$data->harga_item}}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="item_stok" name="stok_item" required min="1" class="text_field" placeholder="Stok Item..." value="{{$data->stok_item}}">
                                    </div>
                            ...
                            <!-- submit button -->
                            <button type="submit" class="btn btn--round btn--fullwidth btn--lg">Ubah Data Item!</button>
                        </form>
                    </div>
                    <!-- end /.col-md-8 -->
